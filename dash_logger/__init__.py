...
from .manager import DashLogManager, get_logger, create_logger, init_app
...
_js_dist.extend(
    [
        {"relative_package_path": "dash_logger.min.js", "namespace": package_name},
        {
...
_css_dist = [
    {
        ...
        "external_url": (
            "https://unpkg.com/dash_logger@0.0.1/dash_logger/assets/dash_logger.css"
        ),
...
# Create a singleton instance of the log manager
